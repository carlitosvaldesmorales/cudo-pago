(()=>{
const API='https://cudo-sports-event-bus.carlos-valdes-morales.workers.dev',FALLBACK='../data/championship-fixture.json',SERIES_DATA='../data/anfa-chepica-2026-series-results.json',V='20260909-logos03b';
